...
module.exports = function Sequence(exercises, data) {
  ...
  //data.set('completed', function(completed) {
    //completed = completed || []
    //return completed.filter(function(name) {
...
module.exports = before(module.exports, function(exercises) {
  if (!exercises) throw new Error('Sequence needs exercises: \n' + JSON.stringify(exercises))
  if (!exercises.length) throw new Error('Sequence needs at least one exercise: \n' + JSON.stringify(exercises))
})
